 ...
 * Last modified 4/10/24, 8:38 PM
 */

package com.masewsg.app.ui.components.button
...
fun ComposeOutlinedButton(
    ...
    OutlinedButton(
        ...
        border = BorderStroke(
            width = ComposeButtonDefaults.OutlinedButtonBorderWidth,
            color = if (enabled) {
                MaterialTheme.colorScheme.outline
            } else {
                MaterialTheme.colorScheme.onSurface.copy(
                    alpha = ComposeButtonDefaults.DISABLED_OUTLINED_BUTTON_BORDER_ALPHA,
                )
            },
        ),
        contentPadding = contentPadding,
 ...
 */
@Composable
private fun ComposeButtonContent(
    text: @Composable () -> Unit,
    leadingIcon: @Composable (() -> Unit)? = null,
) {
    if (leadingIcon != null) {
...
fun ComposeButtonPreview() {
    ComposeTheme {
        ComposeBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            ComposeButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun ComposeOutlinedButtonPreview() {
    ComposeTheme {
        ComposeBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            ComposeOutlinedButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun ComposeButtonLeadingIconPreview() {
    ComposeTheme {
        ComposeBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            ComposeButton(
                onClick = {},
                text = { Text("Test button") },
                leadingIcon = { Icon(imageVector = ComposeIcons.Info, contentDescription = null) },
            )
        }
    }
}
