 ...
 * Last modified 4/10/24, 8:57 PM
 */

package com.nphausg.app.ui.components.button
...
fun ImsOutlinedButton(
    ...
    OutlinedButton(
        ...
        border = BorderStroke(
            width = ImsButtonDefaults.OutlinedButtonBorderWidth,
            color = if (enabled) {
                MaterialTheme.colorScheme.outline
            } else {
                MaterialTheme.colorScheme.onSurface.copy(
                    alpha = ImsButtonDefaults.DISABLED_OUTLINED_BUTTON_BORDER_ALPHA,
                )
            },
        ),
        contentPadding = contentPadding,
...
@ThemePreviews
@Composable
fun ImsButtonPreview() {
    ImsTheme {
        ImsBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            ImsButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun ImsOutlinedButtonPreview() {
    ImsTheme {
        ImsBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            ImsOutlinedButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun ImsButtonLeadingIconPreview() {
    ImsTheme {
        ImsBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            ImsButton(
                onClick = {},
                text = { Text("Test button") },
                leadingIcon = { Icon(imageVector = ImsIcons.Info, contentDescription = null) },
            )
        }
    }
}
